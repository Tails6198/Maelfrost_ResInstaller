namespace MaelfrostInstaller.Pages
{
    partial class ProgressPage
    {
        ...
        {
            this.ProgressBar = new MaelfrostInstaller.Controls.CustomProgressBar();
            ...
            this.label2.Text = "Project Maelfrost has better Win32 DPI support.\nEverything should be more clear on higher resolutions as it scales controls correctly.\n\nUnlike Windows 11, that is.";
            // 
            // lblCurrent
            // 
